      ...
      <div className={"mx-auto min-h-screen w-[50rem] font-red-hat-text"}>
        ...
        <section className={"rounded-lg bg-white p-6"}>
          ...
          <div className={"flex items-center p-6"}>
            <span className={"text-[0.875rem] leading-[150%] text-rose-900"}>Order Total</span>
          ...
          {/*        <div>*/}
          {/*            <h3 className={"text-[0.875rem] text-rose-900 leading-[150%]"}>Classic Tiramisu</h3>*/}
          {/*            <div className={"flex gap-x-[.5rem] pt-[.5rem]"}>*/}
          {/*                <span className={"text-[0.875rem] text-red leading-[150%] font-bold"}>1x</span>*/}
          {/*                <span className={"text-[0.875rem] text-rose-500 leading-[150%]"}>@$5.50</span>*/}
          {/*                <span className={"text-[0.875rem] text-rose-500 leading-[150%] font-bold"}>$5.50</span>*/}
          {/*            </div>*/}
          {/*        </div>*/}
